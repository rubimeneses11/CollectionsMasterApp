...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        ...
        {
            for (int i = 0; i < numbers.Length; i++) //will put in for loop to go thru each number in array
            {
                Random rng = new Random(); //random number generator
                numbers[i] = rng.Next(0, 50); //giving the range that you want and putting it in i
            }
